...
public class SoundManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClipsRefSO audioClipsRefsSO;
    ...
    private void Start()
    {
        DeliveryManager.Instance.OnRecipeSucess += DeliveryManage_OnRecipeSucess;
    ...
    private void DeliveryManager_OnRecipeFailed(object sender, System.EventArgs e)
    {
        ...
        PlaySound(audioClipsRefsSO.devliveryFail, deliveryCounter.transform.position);
    }

    private void DeliveryManage_OnRecipeSucess(object sender, System.EventArgs e)
    {
        DeliverCounter deliveryCounter = DeliverCounter.Instance;
    ...
    public void PlayCountdownPopupSound()
    {
